...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ticket movieTicket = new ticket(glommaFestivalen.getEventName(),LocalDate.of(2019, 04, 15),"Fredrikstad",1500, 4,5);
        ticket movieTicket1 = new ticket(glommaFestivalen.getEventName(),LocalDate.of(2019, 04, 15),"Fredrikstad",1500, 4,5);
        ticket movieTicket2 = new ticket(glommaFestivalen.getEventName(),LocalDate.of(2019, 04, 15),"Fredrikstad",1500, 4,5);
